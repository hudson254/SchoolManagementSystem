# -*- coding: utf-8 -*-
# Seed SQL for the assessment grading migration.
...
A_COLS = '"id", "Name", "Code", "Description", "Category", "IsActive", "IsSystemDefined", "SortOrder", "tenant_id", "created_at", "updated_at", "is_deleted"'

def assessment_insert(name, code, desc, cat, order):
    return (
        'INSERT INTO "AssessmentTypes" (' + A_COLS + ')\n'
...
B_COLS = '"id", "GradingScaleId", "GradeLetter", "Description", "MinPercentage", "MaxPercentage", "GpaPoints", "ColorCode", "HonorsClassification", "SortOrder", "tenant_id", "created_at", "updated_at", "is_deleted"'

def band_insert(bid, letter, desc, lo, hi, gpa, color, hon, order):
    hon_sql = "NULL" if hon is None else "'" + hon + "'"
    return (
        'INSERT INTO "GradeBands" (' + B_COLS + ')\n'
