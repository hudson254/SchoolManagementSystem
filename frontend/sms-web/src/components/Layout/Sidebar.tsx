...
const menuItems: MenuItem[] = [
  ...
  },
  {
    text: 'Academic',
    icon: <MenuBook />,
    roles: ['SystemAdministrator', 'Administrator', 'Coordinator'],
    children: [
      { text: 'Courses', icon: <Book />, path: '/courses', roles: ['SystemAdministrator', 'Administrator', 'Coordinator'] },
      { text: 'Course Offerings', icon: <EventNote />, path: '/course-offerings', roles: ['SystemAdministrator', 'Administrator', 'Coordinator'] },
  ...
  },
  {
    ...
    icon: <Grading />,
    path: '/assignments',
    roles: ['SystemAdministrator', 'Administrator', 'Coordinator', 'Lecturer'],
  },
  {
    text: 'Grades',
    icon: <Assessment />,
